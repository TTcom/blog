import{_ as s,o as n,c as a,a as l}from"./app.9328da71.js";const F=JSON.parse('{"title":"call_apply_bind","description":"","frontmatter":{},"headers":[{"level":3,"title":"javascript中的this、call、apply、bind的区别","slug":"javascript中的this、call、apply、bind的区别","link":"#javascript中的this、call、apply、bind的区别","children":[]}],"relativePath":"javascript/call_apply_bind.md"}'),p={name:"javascript/call_apply_bind.md"},t=l(`<h1 id="call-apply-bind" tabindex="-1">call_apply_bind <a class="header-anchor" href="#call-apply-bind" aria-hidden="true">#</a></h1><h3 id="javascript中的this、call、apply、bind的区别" tabindex="-1">javascript中的this、call、apply、bind的区别 <a class="header-anchor" href="#javascript中的this、call、apply、bind的区别" aria-hidden="true">#</a></h3><p>简书原文链接<a href="https://www.jianshu.com/p/bc541afad6ee" target="_blank" rel="noreferrer"></a></p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">//call apply bind</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div>`,4),o=[t];function e(c,i,y,r,E,f){return n(),a("div",null,o)}const B=s(p,[["render",e]]);export{F as __pageData,B as default};
