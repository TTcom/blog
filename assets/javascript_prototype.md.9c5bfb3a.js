import{_ as s,o as n,c as a,a as l}from"./app.9328da71.js";const E=JSON.parse('{"title":"原型链","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/prototype.md"}'),o={name:"javascript/prototype.md"},p=l(`<h1 id="原型链" tabindex="-1">原型链 <a class="header-anchor" href="#原型链" aria-hidden="true">#</a></h1><p>prototype和__proto__的区别<a href="https://www.jianshu.com/p/80bcf8b2004e" target="_blank" rel="noreferrer"></a></p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"></span></code></pre></div>`,3),t=[p];function e(c,r,y,D,i,F){return n(),a("div",null,t)}const _=s(o,[["render",e]]);export{E as __pageData,_ as default};
